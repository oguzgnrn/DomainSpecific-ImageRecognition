...
for lr in learning_rate:
  for fn in fold_name:
    ...
    inception = tf.keras.applications.VGG19(
        include_top=False,
        weights="imagenet",
    ...
    model.save(main_path +'VGG19Results/_VGG19_'+str(epoch)+'_'+str(ooptimizer) +'_'+str(lr)+'_'+fn+'')
    ...
    plt.title(title)
    plt.savefig(main_path +'VGG19Results/_confusion_matrix_VGG19_'+str(epoch)+'_'+str(ooptimizer) +'_'+str(lr)+'_'+fn+'_'+str(time)+'dk_'+str(accuracy)+'%.png',format="png",dpi=300,bbox_inches='tight')
