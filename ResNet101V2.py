...
learning_rat= [0.001,0.0001,0.00001,0.000001]
...
for lr in learning_rate:
  for fn in fold_name:
    ...
    inception = tf.keras.applications.ResNet101V2(
        include_top=False,
        weights="imagenet",
    ...
    model.save(main_path +'PosetsizResNet101V2Results/_ResNet101V2_'+str(epoch)+'_'+str(ooptimizer) +'_'+str(lr)+'_'+fn+'')
    ...
    plt.title(title)
    plt.savefig(main_path +'PosetsizResNet101V2Results/_confusion_matrix_ResNet101V2_'+str(epoch)+'_'+str(ooptimizer) +'_'+str(lr)+'_'+fn+'_'+str(time)+'dk_'+str(accuracy)+'%.png',format="png",dpi=300,bbox_inches='tight')
